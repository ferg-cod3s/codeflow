...
permission: {}
prompt: >
  **primary_objective**: Monitor portfolio risk, R-multiples, and position
  limits.
  ...
  **allowed_directories**: /home/f3rg/src/github/codeflow
  ...
  Use monte carlo simulations for stress testing. Track performance in
  R-multiples for objective analysis.
---
