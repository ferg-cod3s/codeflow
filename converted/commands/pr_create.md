...
template: >-
  ...
  **Input**: $ARGUMENTS
  ...
  The `pr-create` command automates the creation of pull requests with
  comprehensive descriptions, automated reviews, and proper validation,
  ...
  This command ensures pull requests are created with high-quality descriptions,
  appropriate reviewers, and thorough validation, improving collaboration and
  code quality.
  ...
  - **Auto-Generated Descriptions**: Intelligent description generation based on
  changes

  - **Comprehensive Validation**: Code review, security scanning, and
  ...
  pr-create title='Fix security vulnerability' reviewers=['@security-team',
  '@lead-dev'] labels=['security', 'urgent']
  ...
  Use this command to create high-quality pull requests that facilitate
  efficient code review and collaboration.
---
