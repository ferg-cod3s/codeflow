...
template: >-
  ...
  **Input**: $ARGUMENTS
  ...
  The `audit` command performs comprehensive audits of your codebase,
  dependencies, and infrastructure against security standards, compliance
  ...
  This command provides thorough assessment and reporting to ensure your
  applications meet security, compliance, and quality standards, helping
  maintain a robust and secure development lifecycle.
  ...
  - **Comprehensive Scoping**: Code, dependencies, infrastructure, compliance,
  security
  ...
  audit scope=full standards=['OWASP', 'SOC2'] depth=comprehensive
  ...
  Use this command to ensure your applications maintain high standards of
  security, compliance, and quality throughout their lifecycle.
subtask: true
---
