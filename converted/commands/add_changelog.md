...
template: >-
  ...
  **Input**: $ARGUMENTS (optional: format, version)
  ...
  Generate and maintain a project changelog following the [Keep a
  Changelog](https://keepachangelog.com/en/1.0.0/) format, with support for
  ...
  Create or update a CHANGELOG.md file that tracks all notable changes to the
  project in a human-readable format, organized by version and change type.
