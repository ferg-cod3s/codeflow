...
template: >-
  ...
  **Input**: $ARGUMENTS
  ...
  The `code-review` command performs comprehensive automated code review and
  quality validation across multiple dimensions including security, performance,
  style, architecture, and best practices. It provides detailed analysis,
  actionable recommendations, and automatic fixes where possible.
  ...
  **Objective:** Analyze code for performance issues and optimization
  opportunities
  ...
  **Parallel Execution:**
  ...
  /code-review target="feature-branch" review_type="comprehensive"
  severity_threshold="minor" auto_fix=true framework_rules=["react","nodejs"]
  ...
  /code-review target="pull-request-123" review_type="security"
  severity_threshold="major" auto_fix=false
  ...
  /code-review target="src/performance-critical/" review_type="performance"
