...
template: >-
  ...
  **Input**: $ARGUMENTS
  ...
  The `migrate` command performs database schema and data migrations with zero
  downtime capabilities. It provides comprehensive migration planning,
  execution, validation, and rollback procedures for safe database changes.
  ...
  **Parallel Execution:**
  ...
  /migrate migration_type="schema" source="v1.0" target="v1.1"
  downtime_allowed=false rollback_strategy="automatic"
  ...
  /migrate migration_type="data" source="legacy_system" target="new_system"
  downtime_allowed=true rollback_strategy="manual"
  ...
  /migrate migration_type="both" source="postgres_12" target="postgres_14"
  downtime_allowed=false rollback_strategy="automatic"
  validation_level="thorough"
