...
- `research/plans/2025-09-17_smart-subagent-orchestrator-prompt-optimization-implementation.md` - Discusses command prompt optimization
- `research/documentation/2025-08-31-setup-agents-api.md` - Agent setup and command integration
- `research/research/2025-08-26_automated-global-configs-mcp-integration.md` - MCP integration patterns
