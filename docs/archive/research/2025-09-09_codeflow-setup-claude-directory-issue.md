...
- `research/research/2025-09-05_codeflow-setup-command-copy-issue.md` - Command copying source path issues
- `research/research/2025-08-31_codeflow-setup-agents-issue.md` - Agent conversion and directory setup issues
- `research/plans/fix-command-setup-strategy.md` - Detailed fix plan for command setup
- `research/plans/setup-agents-modular-implementation-plan.md` - Agent setup implementation plan
...
- `research/research/2025-09-05_codeflow-setup-command-copy-issue.md` - Command setup issues
- `research/research/2025-08-31_codeflow-setup-agents-issue.md` - Agent setup issues
- `research/plans/fix-command-setup-strategy.md` - Command setup fix plan
- `research/plans/setup-agents-modular-implementation-plan.md` - Agent setup implementation
