...
- `research/research/2025-09-04_subagent-permission-issues.md` - Permission denied errors analysis
- `research/research/2025-09-05_opencode-agent-permission-format-mismatch.md` - Format mismatch investigation
- `research/plans/fix-opencode-agent-format-compliance.md` - Implementation plan for compliance
