...
- `research/research/2025-09-02_agent-permissions-gap-analysis.md` - Comprehensive audit of permission inconsistencies
- `research/research/2025-08-31_sync-global-opencode-agent-errors.md` - Root cause analysis of sync validation failures
- `research/research/2025-09-02_allowed-directories-global-sync.md` - Directory access configuration analysis

### Implementation Plans

- `research/plans/agent-permissions-audit-and-update.md` - Comprehensive permission update plan
- `research/plans/fix-sync-global-opencode-issues.md` - Sync validation fixes
- `research/plans/opencode-file-editing-compatibility-fix.md` - File access permission fixes
...
- `research/research/2025-09-02_allowed-directories-global-sync.md`
- `research/plans/agent-permissions-audit-and-update.md`
- `research/plans/fix-sync-global-opencode-issues.md`
