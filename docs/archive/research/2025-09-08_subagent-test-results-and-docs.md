...
- **Onboarding and setup patterns** are well-documented, with guides in `README.md`, `docs/`, and `research/`.
- **Historical context** from the `research/` directory highlights registry QA, setup failures, permission issues, and architecture changes.
...
- Defined in:
  ...
  - `codeflow-agents/generalist/research-locator.md`
  - `codeflow-agents/generalist/research-analyzer.md`
...
- Core registry logic in:
  ...
  - `packages/agentic-mcp/src/agent-registry.ts`
  - `src/cli/status.ts`
- Documentation and QA reporting in `research/`, `docs/`, and CLI status commands.
...
- Main guides in:
  ...
  - Onboarding-specific files in `research/documentation/` and `research/plans/`
...
- Documentation files in `docs/` and `research/` directories provide high-level and detailed onboarding patterns.
...
- `research/research/2025-09-07_agent-registry-qa-docs-integration.md` — Registry QA research
...
- `research/research/2025-09-07_agent-registry-qa-docs-integration.md` — Registry QA, validation, canonical agent definitions.
- `research/research/2025-09-07_opencode-agents-problems.md` — Registry/documentation drift, naming inconsistencies.
- `research/research/2025-09-06_frontmatter-issues-investigation.md` — Frontmatter validation and setup/sync workflows.
- `research/research/2025-09-05_codeflow-setup-command-copy-issue.md` — Setup command onboarding issues.
- `research/research/2025-08-31_codeflow-setup-agents-issue.md` — Agent setup failures, conversion step and directory configuration.
- `research/plans/agent-registry-qa-docs-integration.md` — Plan to improve registry reliability, enforce schema/permissions.
- `research/plans/opencode-agent-compliance-checklist.md` — Compliance, naming conventions, audit steps.
- `research/plans/frontmatter-architecture-overhaul.md` — Frontmatter architecture overhaul.

## Related Research

- `research/research/2025-09-07_agent-registry-qa-docs-integration.md`
- `research/research/2025-09-07_opencode-agents-problems.md`
- `research/research/2025-09-06_frontmatter-issues-investigation.md`
- `research/research/2025-09-05_codeflow-setup-command-copy-issue.md`
- `research/research/2025-08-31_codeflow-setup-agents-issue.md`
