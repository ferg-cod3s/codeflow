...
1. **Base Format** (agent/ directory):
   ...
   - Core workflow agents (codebase-analyzer, research-locator, etc.)
...
No existing research/ directory found - this is the first research document for this repository.
