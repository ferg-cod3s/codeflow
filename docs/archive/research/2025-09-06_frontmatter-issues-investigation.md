...
- `research/research/2025-09-05_opencode-yaml-frontmatter-mangling.md` - Previous investigation of YAML issues
- `research/research/2025-09-05_opencode-agent-permission-format-mismatch.md` - Permission format conflicts
- `research/research/2025-08-31_sync-global-opencode-agent-errors.md` - Sync validation failures
- `research/research/2025-08-31_codeflow-setup-agents-issue.md` - Setup process issues
