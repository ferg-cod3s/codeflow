...
- `research/plans/fix-opencode-agent-format-compliance.md` - Previous format compliance fixes
- `research/plans/fix-opencode-subagent-permissions.md` - Permission-related fixes
- `research/plans/fix-sync-global-opencode-issues.md` - Global sync issues
...
- `research/research/opencode-agents-problems.md` - Previous OpenCode agent issues
