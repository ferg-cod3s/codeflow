...
- `research/research/2024-03-12_agent_conversion_failures.md` - Analysis of common conversion errors
- `research/research/2024-02-28_yaml_formatting_edge_cases.md` - YAML formatting investigation
- `research/research/2024-01-20_permission_conversion_analysis.md` - Permission conversion research
- `research/research/2024-04-05_global_sync_failures.md` - Historical sync failure analysis

**Implementation Plans**:

- `research/plans/agent-conversion-improvements.md` - Conversion reliability improvements
- `research/plans/yaml-normalization-strategy.md` - YAML normalization approach
- `research/plans/permission-sync-fix.md` - Permission conversion fixes
...
- `research/research/2025-09-05_opencode-agent-permission-format-mismatch.md` - Recent permission format analysis
- `research/research/2025-09-06_opencode-agent-validation-failures.md` - Validation failure investigation
- `research/research/2025-09-07_yaml-normalization-edge-cases.md` - YAML edge case handling
