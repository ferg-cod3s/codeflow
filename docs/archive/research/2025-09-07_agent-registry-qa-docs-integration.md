...
- Architectural decisions in research/ confirm a single source of truth, unified validation/conversion, strict naming/location conventions, and automated QA/testing.
...
- `research/architecture/overview.md` — Overall system architecture and MCP integration.
- `research/plans/frontmatter-architecture-overhaul.md` — Unified frontmatter, validation-first design.
- `research/plans/opencode-agent-compliance-checklist.md` — Naming/location compliance and drift mitigation.
- `research/research/2025-09-07_opencode-agents-problems.md` — Registry invocation errors and architectural changes.
- `research/research/2025-09-05_opencode-agent-permission-format-mismatch.md` — Permission format mismatches and registry/QA impact.

## Related Research

- `research/research/2025-09-04_subagent-permission-issues.md` — Subagent permission denials and validation.
- `research/research/2025-08-30_agent-format-validation.md` — Cross-format validation for Claude Code, OpenCode, Base.
