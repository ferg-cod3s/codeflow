...
`research/plans/opencode-file-editing-compatibility-fix.md`
...
- `research/plans/opencode-file-editing-compatibility-fix.md` - Historical
...
• Original research: research/research/YYYY-MM-DD_topic.md
• Permission logic: src/security/opencode-permissions.ts:106-145
• Frontmatter parsing: src/conversion/agent-parser.ts:126-222
• Historical context: research/plans/opencode-file-editing-compatibility-fix.md
