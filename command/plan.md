...
3. **Spawn Parallel Research**: Launch codebase-locator, codebase-analyzer, and knowledge-locator agents
...
- **knowledge-locator**: Find existing research and decisions
- **knowledge-analyzer**: Extract insights from documentation
...
- **knowledge-locator**: Discovers existing plans, architectural decisions, and technical constraints
- **codebase-pattern-finder**: Identifies established implementation patterns for similar features
- **knowledge-analyzer**: Extracts insights from past planning decisions and outcomes
