...
- `knowledge-locator` - Discovers existing documentation about topics
- `knowledge-analyzer` - Extracts insights from specific documents
...
- **Research Tasks**: Use `codebase-locator` + `knowledge-locator` first, then `codebase-analyzer` + `knowledge-analyzer`
...
- **Documentation**: Use `knowledge-analyzer` for synthesizing information into structured docs
...
- **Documentation Tasks**: `knowledge-locator` → `knowledge-analyzer` → document synthesis
