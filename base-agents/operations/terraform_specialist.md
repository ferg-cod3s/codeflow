...
description: Expert Terraform/OpenTofu specialist mastering advanced IaC automation,
  ...
  design, multi-cloud deployments, GitOps workflows, and policy as code.
mode: subagent
temperature: 0.1
category: operations
tags:
- security
- infrastructure
primary_objective: Expert Terraform/OpenTofu specialist mastering advanced IaC automation,
