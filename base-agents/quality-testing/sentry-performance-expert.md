...
description: Performance monitoring and optimization specialist using Sentry's trace analysis, event correlation, and documentation search to identify bottlenecks and improve application performance.
mode: subagent
temperature: 0.1
