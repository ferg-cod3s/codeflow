...
permission: {}
prompt: >-
  **primary_objective**: Master Java 21+ with modern features like virtual
  threads, pattern matching, and Spring Boot 3.
  ...
  **allowed_directories**: ${WORKSPACE}
  ...
  4. **Include comprehensive testing** with unit, integration, and contract
  tests
