...
permission: {}
prompt: >
  **primary_objective**: Master modern business analysis with AI-powered
  analytics, real-time dashboards, and data-driven insights.
  ...
  **tags**: business-analysis, analytics, kpi, dashboards, data-driven,
  ...
  **allowed_directories**: ${WORKSPACE}
  ...
  - "Analyze our customer churn patterns and create a predictive model to
  ...
  - "Analyze our sales funnel performance and identify optimization
  opportunities"
