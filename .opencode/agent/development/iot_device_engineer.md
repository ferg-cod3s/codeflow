...
permission:
  ...
  swd: allow
  oscilloscopes: allow
  logic-analyzers: allow
  wireless-protocol-analyzers: allow
  power-profiling-tools: allow
  firmware-security-analysis-tools: allow
  iot-platform-sdks: allow
  version-control-embedded: allow
  continuous-integration-firmware: allow
  device-simulation-frameworks: allow
