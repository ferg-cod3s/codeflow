...
description: Release tracking and deployment monitoring specialist using Sentry's release management, DSN configuration, and documentation search to ensure smooth deployments and monitor post-release stability.
mode: subagent
temperature: 0.1
permission:
  edit: deny
