...
description: Lead Sentry-based incident response from detection through resolution. Coordinate teams, analyze issues, manage communications, and drive post-incident improvements using Sentry's comprehensive error tracking and team management tools.
mode: subagent
temperature: 0.2
permission:
  edit: allow
