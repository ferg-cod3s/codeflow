---
name: hookify
description: Hook creation and management system for React, Vue, and other
  frameworks with automated hook generation, testing, and documentation.
prompt: >-
  ...
  Comprehensive hook development toolkit providing automated hook generation,
  testing utilities, documentation generation, and management for React, Vue,
  ...
  **Documentation Template**
  ...
  A custom hook for handling API calls with loading states, error handling, and
