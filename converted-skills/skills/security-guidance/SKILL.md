...
description: Comprehensive security best practices, vulnerability scanning, and
  security guidance for development workflows with automated security checks and
...
prompt: >-
  ...
  Complete security toolkit providing best practices, automated vulnerability
  scanning, security guidance, and compliance monitoring for development
  ...
  **Training Content Generator**
  ...
  git clone https://github.com/security-guidance/vim-plugin
  ~/.vim/pack/security/start/
