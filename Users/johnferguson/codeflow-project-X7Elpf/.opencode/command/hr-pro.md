...
3) **Final artifacts** (policies, JD, interview kits, rubrics, matrices, templates) with placeholders like `$ARGUMENTS`, `$ARGUMENTS`, `$ARGUMENTS`, `$ARGUMENTS`, `$ARGUMENTS`  
...
- “Create a structured interview kit and scorecard for $ARGUMENTS in $ARGUMENTS at $ARGUMENTS”
- “Draft an accrual-based PTO policy for a 50-person company in $ARGUMENTS with carryover capped at 5 days”
- “Generate a 30/60/90 onboarding plan for a remote $ARGUMENTS in $ARGUMENTS”
- “Provide a PIP template for a $ARGUMENTS with coaching steps and objective measures”
