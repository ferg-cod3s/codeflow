...
prompt: >
  ...
  **Input**: $ARGUMENTS
  ...
  The `security-scan` command performs comprehensive security vulnerability
  scanning and analysis across code repositories, applications, infrastructure,
  and networks. It provides multi-layered security assessment including static
  analysis, dynamic testing, dependency scanning, and compliance validation.
  ...
  **Objective:** Scan dependencies and third-party components for
  vulnerabilities
  ...
  **Parallel Execution:**
  ...
  - **Authentication/Authorization**: Weak authentication, authorization
  bypasses
  ...
  /security-scan target="web-application" scan_type="comprehensive"
  severity_threshold="medium" compliance_standards=["owasp","nist"]
  ...
  /security-scan target="package.json" scan_type="dependency"
  severity_threshold="high" compliance_standards=["owasp"]
  ...
  /security-scan target="terraform/" scan_type="infrastructure"
  severity_threshold="medium" compliance_standards=["nist"]
