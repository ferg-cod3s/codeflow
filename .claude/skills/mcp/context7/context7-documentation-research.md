...
description: Research and retrieve comprehensive library documentation using Context7's powerful API documentation system. Enables deep exploration of any library's API, examples, and implementation patterns.
license: MIT
allowed-tools: [Context7_resolve_library_id, Context7_get_library_docs]
metadata:
  category: mcp/context7
  mcp_server: context7
  version: '1.0.0'
  author: 'CodeFlow Team'
  tags: [documentation, research, api, libraries, context7]
noReply: true
---
