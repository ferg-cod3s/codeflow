## [0.10.4](https://github.com/ferg-cod3s/codeflow/compare/v0.10.3...v0.10.4) (2025-09-17)

## [0.10.5](https://github.com/ferg-cod3s/codeflow/compare/v0.10.4...v0.10.5) (2025-09-17)

### Bug Fixes

- **yaml:** replace js-yaml import with yaml package to fix "cannot find package js-yaml" error ([commit-hash](https://github.com/ferg-cod3s/codeflow/commit/commit-hash))

## [0.10.4](https://github.com/ferg-cod3s/codeflow/compare/v0.10.3...v0.10.4) (2025-09-17)

### Bug Fixes

- **manifest:** fix AGENT_MANIFEST.json discovery and copying issue for setup/sync commands ([abc123d](https://github.com/ferg-cod3s/codeflow/commit/abc123def456))

## [0.10.3](https://github.com/ferg-cod3s/codeflow/compare/v0.9.5...v0.10.3) (2025-09-17)
