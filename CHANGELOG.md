# [0.9.1](https://github.com/ferg-cod3s/codeflow/compare/v0.9.0...v0.9.1) (2025-09-02)

### Refactor

- Remove all `.opencode/permissions.json` logic; permissions and allowed directories are now sourced only from agent file frontmatter.
- Ensure project-specific agent files override global/built-in during sync.

### Documentation

- Clarify permissions source and override order in architecture docs.
